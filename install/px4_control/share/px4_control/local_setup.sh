...
: ${AMENT_CURRENT_PREFIX:="/home/albertocastro/px4_drone/install/px4_control"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4_control/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/px4_control/environment/path.sh"
